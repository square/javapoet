...
public final class TypeVariableName implements TypeName {
  ...
  private final Optional<TypeName> bound;

  TypeVariableName(String name, Optional<TypeName> bound) {
    this.name = name;
    this.bound = bound;
  }
  ...
  public static TypeVariableName create(String name, TypeName bound) {
    return new TypeVariableName(name, Optional.of(bound));
  }
  ...
  public Set<ClassName> referencedClasses() {
    return FluentIterable.from(bound.asSet())
  ...
  public Appendable write(Appendable appendable, Context context) throws IOException {
    ...
    if (bound.isPresent()) {
      ...
      bound.get().write(appendable, context);
    }
    return appendable;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hashCode(name, bound);
  }

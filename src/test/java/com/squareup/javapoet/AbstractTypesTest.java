...
public abstract class AbstractTypesTest {
    ...
    public void getArrayTypeMirror() {
        assertThat(TypeName.get(getTypes().getArrayType(getMirror(Object.class)))).isEqualTo(ArrayTypeName.of(ClassName.OBJECT));
    }
    ...
    public void typeVariable() throws Exception {
        ...
        // (Bounds are only emitted in declaration.)
